...
handleChange(event) {
  ...
  return (
    <div>
<h4>Mine TRX and Receive TCDN</h4>
<div>
...
<CardDeck>     
  ...
  <CardSubtitle><UserInfo/></CardSubtitle>
      ...
      <Card style={{ backgroundColor: '#333', borderColor: '#e60073' }}>
        <CardBody>
          <CardTitle>Withdraw TCDN</CardTitle>
        ...
        <br/>
        <input type="submit" value="Withdraw TCDN" />
      </form>
      <CardTitle>Withdraw TRX</CardTitle>
...
<br/>
<input type="submit" value="Withdraw TRX" />
</form>
        </CardBody>
      </Card>
    </CardDeck>
